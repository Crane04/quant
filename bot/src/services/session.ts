...
export type SessionState =
  ...
  | "AWAITING_ASSIGNMENT_DETAILS"
  | "AWAITING_ASSIGNMENT_EMPTY_CHOICE"
  | "AWAITING_ASSIGNMENT_ACTION_CHOICE"
  | "AWAITING_CGPA_TARGET"
  | "AWAITING_CGPA_EMPTY_CHOICE"
  | "AWAITING_PROFILE_EDIT_FIELD"
  | "AWAITING_PROFILE_EDIT_VALUE"
  | "AWAITING_FEEDBACK";
